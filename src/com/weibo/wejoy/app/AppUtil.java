...
public class AppUtil {
	...
	public String requestGetUrl(String url, Map<String, String> headers,
		...
		String result = null;
		try {
			result = requestGetUrlTask.get(5000, TimeUnit.MILLISECONDS);
			return result;
		} catch (Exception e) {
	...
	public String requestPostUrl(String url, Map<String, String> headers,
		...
		try {
			int timeout = url.indexOf("login") >= 0 ? 5000 : 5000;
	...
	public String postMultipartUrl(String url, Map<String, String> headers,
		...
		try {
			result = postMultipartUrlTask.get(5000, TimeUnit.MILLISECONDS);
			return result;
		} catch (Exception e) {
			log.warn(
